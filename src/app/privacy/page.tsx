        ...
        <>
            ...
            <main className="min-h-screen min-w-screen bg-white text-gray-900 mb-6">
                <div className=" mx-32 mb-12">
                    <h1 className="text-[40px] font-bold mb-6 text-center text-[#C2613D] pt-6">Privacy Policy</h1>
                    ...
                    <h2 className="text-2xl font-medium mb-4 text-[#C2613D]">Interpretation and Definitions</h2>
                    <h3 className="text-xl font-medium mb-4 text-[#C2613D]">Interpretation</h3>
                    <p className="mb-3">
                        The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                    </p>
                    <h3 className="text-xl font-medium mb-4 text-[#C2613D]">Definitions</h3>
                    <p className="mb-3">
                    ...
                    <h2 className="text-2xl font-medium mb-6 text-[#C2613D]">Collecting and Using Your Personal Data</h2>
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Types of Data Collected</h3>
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Personal Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Usage Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Tracking Technologies and Cookies</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Use of Your Personal Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Retention of Your Personal Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Transfer of Your Personal Data</h3>
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Delete Your Personal Data</h3>
                    <p className="mb-3"> You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Disclosure of Your Personal Data</h3>
                    <h3 className="text-l font-medium mb-3 text-[#C2613D]">Business Transactions</h3>
                    <p className="mb-6">
                        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                    </p>
                    <h3 className="text-l font-medium mb-3 text-[#C2613D]">Law enforcement</h3>
                    <p className="mb-6">
                    ...
                    <h3 className="text-l font-medium mb-3 text-[#C2613D]">Other legal requirements</h3>
                    <p className="mb-6">
                    ...
                    <h3 className="text-xl font-medium mb-3 text-[#C2613D]">Security of Your Personal Data</h3>
                    <p className="mb-6">
                    ...
                    <h2 className="text-2xl font-medium mb-4 text-[#C2613D]">Children’s Privacy</h2>
                    <p className="mb-3">
                    ...
                    <h2 className="text-2xl font-medium mb-4 text-[#C2613D]">Links to Other Websites</h2>
                    <p className="mb-3">
                    ...
                    <p className="mb-3">We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.
                    </p>
                    <h2 className="text-2xl font-medium mb-4 text-[#C2613D]">Changes to this Privacy Policy</h2>
                    <p className="mb-3">
                    ...
                    <h2 className="text-2xl font-medium mb-4 text-[#C2613D]">Contact Us</h2>
                    <p className="mb-3">
                        If you have any questions about this Privacy Policy, You can contact us:
                    </p>
                    <ul className="list-disc pl-6 mb-6">
                        <li>By email: lochhomesllc@gmail.com</li>
                        <li>By visiting this page on our website: https://lochhomes.com</li>
                    </ul>
