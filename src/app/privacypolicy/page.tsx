...
export default function TermsPage() {
    return (
        <>
            ...
            <nav className="flex flex-col sm:flex-row items-center justify-between px-4 sm:px-8 lg:px-16 py-6 bg-white gap-4 sm:gap-0">
            ...
            <main id="privacy-policy" className="min-h-screen bg-white text-gray-900 mb-6 pb-6 text-justify">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 mb-12 leading-relaxed">
                    ...
                    <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Interpretation and Definitions</h2>
                    <h3 className="text-lg sm:text-xl font-medium mb-4 text-[#C2613D]">Interpretation</h3>
                    <p className="mb-3 text-sm sm:text-base">
                        The words of which the initial letter is capitalized have meanings defined under the following conditions...
                    </p>
                    <h3 className="text-lg sm:text-xl font-medium mb-4 text-[#C2613D]">Definitions</h3>
                    <p className="mb-3 text-sm sm:text-base">
                        For the purposes of this Privacy Policy:
                    </p>
                    <ul className="list-disc pl-6 mb-6 text-sm sm:text-base space-y-2">
                        ...
                        <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Loch Homes LLC, 3300 Hamilton Mill Rd, Ste 102 #999, Buford, GA, 30519.</li>
                        ...
                        <li>Website refers to Loch Homes, accessible from https://lochhomes.com</li>
                        <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                    </ul>
                    <h2 className="text-xl sm:text-2xl font-medium mb-6 text-[#C2613D]">Collecting and Using Your Personal Data</h2>
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Types of Data Collected</h3>
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Personal Data</h3>
                    <p className="mb-3 text-sm sm:text-base">
                    ...
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Usage Data</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Tracking Technologies and Cookies</h3>
                    <p className="mb-3  text-sm sm:text-base">
                    ...
                    <ul className="list-disc pl-6 mb-6 text-sm sm:text-base space-y-2">
                        ...
                        <li><b>Cookies Policy / Notice Acceptance Cookies Type:</b> Persistent Cookies Administered by: Us Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</li>
                        <li><b>Functionality Cookies Type:</b> Functionality Cookies Type: Persistent Cookies Administered by: Us Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</li>
                    </ul>
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Use of Your Personal Data</h3>
                    <p className="mb-3 text-sm sm:text-base">
                        The Company may use Personal Data for the following purposes:
                    </p>
                    <ul className="list-disc pl-6 mb-6 text-sm sm:text-base space-y-2">
                        <li><b>To maintain our Service:</b>  To provide and maintain our Service, including to monitor the usage of our Service.</li>
                        ...
                        <li><b>To provide updates:</b>  To provide You with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</li>
                    ...
                    <ul className="list-disc pl-6 mb-6 text-sm sm:text-base space-y-2">
                        <li><b>With Service Providers:</b>We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.
                            For business transfers: We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
                    ...
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Retention of Your Personal Data</h3>
                    <p className="mb-3 text-sm sm:text-base">
                    ...
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Delete Your Personal Data</h3>
                    <p className="mb-3 text-sm sm:text-base"> You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.
                    ...
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Disclosure of Your Personal Data</h3>
                    <h3 className="text-lg sm:text-l font-medium mb-3 text-[#C2613D]">Business Transactions</h3>
                    <p className="mb-6 text-sm sm:text-base">
                        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                    </p>
                    <h3 className="text-lg sm:text-l font-medium mb-3 text-[#C2613D]">Law enforcement</h3>
                    <p className="mb-6 text-sm sm:text-base">
                    ...
                    <h3 className="text-lg sm:text-l font-medium mb-3 text-[#C2613D]">Other legal requirements</h3>
                    <p className="mb-6 text-sm sm:text-base">
                    ...
                    <h3 className="text-lg sm:text-xl font-medium mb-3 text-[#C2613D]">Security of Your Personal Data</h3>
                    <p className="mb-6 text-sm sm:text-base">
                    ...
                    <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Children’s Privacy</h2>
                    <p className="mb-3 text-sm sm:text-base">
                    ...
                    <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Links to Other Websites</h2>
                    <p className="mb-3 text-sm sm:text-base">
                    ...
                    <p className="mb-3 text-sm sm:text-base">We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.
                    </p>
                    <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Changes to this Privacy Policy</h2>
                    <p className="mb-3 text-sm sm:text-base">
                    ...
                    <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Contact Us</h2>
                    <p className="mb-3 text-sm sm:text-base">
                        If you have any questions about this Privacy Policy, You can contact us:
                    </p>
                    <ul className="list-disc pl-6 mb-6 text-sm sm:text-base space-y-2">
                        <li>By email: lochhomesllc@gmail.com</li>
                        <li>By visiting this page on our website: <a>https://lochhomes.com</a></li>
                    </ul>
