    ...
    <>
      ...
      <main className="min-h-screen bg-white text-gray-900 mb-6">
        <div className=" max-w-7xl mx-auto px-4 sm:px-6 lg:px-16 mb-12 leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Cookies</h2>
          <p className="text-sm sm:text-base mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">License</h2>
          ...
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Hyperlinking to our Content</h2>
          <p className="text-sm sm:text-base mb-3">
          ...
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">iFrames</h2>
          <p className="text-sm sm:text-base mb-3">
            Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.
          </p>
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Content Liability</h2>
          <p className="text-sm sm:text-base mb-3">
            We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.
          </p>
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Reservation of Rights</h2>
          <p className="text-sm sm:text-base mb-3">
            We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.
          </p>
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Removal of links from our website</h2>
          <p className="text-sm sm:text-base mb-3">
          ...
          <h2 className="text-xl sm:text-2xl font-medium mb-4 text-[#C2613D]">Disclaimer</h2>
          <p className="text-sm sm:text-base mb-3">
            To the maximum extent permitted by applicable law, we exclude all representations, warranties and conditions relating to our website and the use of this website. Nothing in this disclaimer will:
          </p>
          <ul className="list-disc pl-6 mb-3 text-sm sm:text-base space-y-2">
            <li>limit or exclude our or your liability for death or personal injury;</li>
            <li>limit or exclude our or your liability for fraud or fraudulent misrepresentation;</li>
            <li>limit any of our or your liabilities in any way that is not permitted under applicable law; or</li>
            <li>exclude any of our or your liabilities that may not be excluded under applicable law.</li>
          </ul>
          <p className="text-sm sm:text-base mb-12">
