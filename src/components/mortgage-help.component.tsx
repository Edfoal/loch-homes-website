export default function MortgageHelpSection() {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-20">
        <div className="bg-[#B5542F] text-white rounded-lg p-6 sm:p-8 text-center">
          <p className="text-sm sm:text-base leading-relaxed">
            ...
            skyrocketing. To learn more about your specific situation, fill out
            the form or give us a call and one of our acquisition team members
            will be glad to answer any of your questions. They can provide quick
